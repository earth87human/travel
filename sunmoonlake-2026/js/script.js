/* ===================================================
   Sun Moon Lake Journey · Interactions
=================================================== */
...
(function() {
  ...
  // ============== CONSOLE GREETING ==============
  console.log('%cSun Moon Lake Journey · 2026', 'font-family: serif; font-size: 24px; color: #c0a15e; padding: 16px;');
  console.log('%c水社 × 涵碧半島 · 兩天一夜潭畔慢旅', 'font-family: serif; font-size: 14px; color: #103a44;');
