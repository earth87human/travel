/* ===================================================
   Greater Bay Journey · Interactions
=================================================== */
...
(function() {
  ...
  // ============== CONSOLE GREETING ==============
  console.log('%cGreater Bay Journey \u00b7 2026', 'font-family: serif; font-size: 24px; color: #c9a875; padding: 16px;');
  console.log('%c深圳・珠海・廣州 · 八日大灣區四人之旅 · 2026.11.12–11.19', 'font-family: serif; font-size: 14px; color: #1a2332;');
